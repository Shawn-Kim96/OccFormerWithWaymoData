...
# Waymo uses 5 cameras (front, front_left, front_right, side_left, side_right)
camera_used = [0, 1, 2, 3, 4]  # all 5 cameras
num_views = 5

# Waymo occupancy classes (you may need to adjust based on your annotation)
class_names = [
...
# Point cloud range for Waymo (adjust based on your needs)
# Waymo typically has larger range than KITTI
...
# Waymo image size: front cameras are 1920x1280, side cameras are 1920x886
data_config = {
    'input_size': (640, 960),  # H x W, adjusted for Waymo
    'resize': (-0.06, 0.11),
    'rot': (-5.4, 5.4),
    'flip': True,
    'crop_h': (0.0, 0.0),
...
grid_config = {
    ...
    'dbound': [2.0, 70.0, 0.5],  # depth range for Waymo
}
...
pose_file = 'data/waymo/cam_infos.pkl'  # camera pose file
